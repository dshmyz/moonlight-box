import{B as y,H as m,L as f,P as t,Y as a,M as o,O as l,X as V,Z as G,az as R,a as C,f as k,ag as r,ay as T,F as N,ab as I,I as E}from"./vendor-bKowFFQW.js";import{_ as b}from"./index-C7N-KONC.js";import{C as $}from"./CodeBlock-f_eVi84Y.js";import"./elementPlus-qIFyr5Rn.js";import"./mermaid-cnjGtJ55.js";import"./clipboard-CWwTdFKP.js";const U={class:"quick-start"},D={key:0,class:"step-content-wrapper"},z={class:"step-card"},A={class:"step-actions"},S={key:1,class:"step-content-wrapper"},H={class:"step-card"},B={key:0,class:"manager-config"},L=["innerHTML"],h={class:"step-actions"},Q={key:2,class:"step-content-wrapper"},F={class:"step-card final-step"},K={class:"action-buttons"},X=y({__name:"QuickStart",setup(w){const d=C(0),p=C("npm"),c=k(()=>({npm:"NPM",maven:"Maven",pypi:"PyPI",go:"Go"})[p.value]),u=k(()=>{const s=window.location.origin;return{npm:`
