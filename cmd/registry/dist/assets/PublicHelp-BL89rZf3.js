import{C as D}from"./CodeBlock-BN7wg3dA.js";import{d as H,c,e,f as o,w as a,r as g,g as n,o as t,h as u,i as y,t as _,F as x,j as O,n as I,k as R,l as S,m,_ as U}from"./index-DVVPmbZB.js";import"./clipboard-D2TQYQUJ.js";const E={class:"public-help-page"},X={class:"help-content"},j={class:"tab-content"},Q={class:"steps-container"},J={key:0,class:"step-card"},K={class:"step-actions"},W={key:1,class:"step-card"},Z={class:"manager-selector"},ee={key:0,class:"config-card"},le={class:"config-title"},se=["innerHTML"],oe={class:"step-actions"},ae={key:2,class:"step-card success-card"},ne={class:"verify-command"},ie={class:"success-result"},te={class:"tab-content"},de={class:"guide-cards"},ce={class:"guide-info"},re={class:"guide-desc"},pe={class:"guide-actions"},ue={class:"tab-content"},me={class:"search-wrapper"},ve={class:"faq-content"},fe=["innerHTML"],ge=H({__name:"PublicHelp",setup(be){const w=g("quickstart"),d=g(0),r=g("npm"),b=g(""),C=g(""),V=m(()=>({npm:"NPM",maven:"Maven",pypi:"PyPI",go:"Go",yum:"Yum/APT"})[r.value]),p=m(()=>window.location.origin),h=m(()=>window.location.host),G=m(()=>({npm:`
