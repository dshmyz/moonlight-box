import{d as y,n as m,c as f,g as t,p as a,i as o,f as l,h as V,t as G,z as R,r as C,k,l as r,_ as b,x as M,F as N,j as I,e as Y}from"./index-XymGmvge.js";import{C as $}from"./CodeBlock-BNJA8cQQ.js";import"./clipboard-CdoHGpzE.js";const U={class:"quick-start"},D={key:0,class:"step-content-wrapper"},z={class:"step-card"},A={class:"step-actions"},S={key:1,class:"step-content-wrapper"},H={class:"step-card"},B={key:0,class:"manager-config"},L=["innerHTML"],h={class:"step-actions"},Q={key:2,class:"step-content-wrapper"},j={class:"step-card final-step"},F={class:"action-buttons"},K=y({__name:"QuickStart",setup(w){const d=C(0),p=C("npm"),c=k(()=>({npm:"NPM",maven:"Maven",pypi:"PyPI",go:"Go"})[p.value]),u=k(()=>{const s=window.location.origin;return{npm:`
