import{d as g,o as m,c as f,b as t,a as o,w as l,f as a,y as M,t as q,j as E,r as C,A as k,i as r,_ as b,h as x,F as V,n as R,k as U}from"./index-DBxFuNM9.js";import{C as $}from"./CodeBlock-B7I6oCdn.js";const Y={class:"quick-start"},D={key:0,class:"step-content-wrapper"},A={class:"step-card"},S={class:"step-actions"},z={key:1,class:"step-content-wrapper"},H={class:"step-card"},L={key:0,class:"manager-config"},B=["innerHTML"],h={class:"step-actions"},j={key:2,class:"step-content-wrapper"},Q={class:"step-card final-step"},F={class:"action-buttons"},K=g({__name:"QuickStart",setup(y){const d=C(0),p=C("npm"),c=k(()=>({npm:"NPM",maven:"Maven",pypi:"PyPI",go:"Go",nuget:"NuGet"})[p.value]),u=k(()=>{const e=window.location.origin;return{npm:`
